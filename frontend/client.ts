...
export namespace cart {
    ...
    export class ServiceClient {
         ...
         */
        public async get(params: { user_id: number }): Promise<ResponseType<typeof api_cart_get_get>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/cart/${encodeURIComponent(params.user_id)}`, {method: "GET", body: undefined})
         ...
         */
        public async remove(params: RequestType<typeof api_cart_remove_remove>): Promise<void> {
            ...
            await this.baseClient.callTypedAPI(`/cart/remove`, {query, method: "DELETE", body: undefined})
        }
    }
}
...
export namespace orders {
    ...
    export class ServiceClient {
        ...
        public async create(params: RequestType<typeof api_orders_create_create>): Promise<ResponseType<typeof api_orders_create_create>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/orders/create`, {method: "POST", body: JSON.stringify(params)})
    ...
    export class ServiceClient {
        ...
        public async list(params: RequestType<typeof api_products_list_list>): Promise<ResponseType<typeof api_products_list_list>> {
            ...
            const query = makeRecord<string, string | string[]>({
                ...
                "max_price":    params["max_price"] === undefined ? undefined : String(params["max_price"]),
                "min_price":    params["min_price"] === undefined ? undefined : String(params["min_price"]),
