...
export namespace auth {
  export class ServiceClient {
    ...
    public async createFromGuest(
      params: RequestType<typeof api_auth_create_from_guest_createFromGuest>
    ): Promise<
      ResponseType<typeof api_auth_create_from_guest_createFromGuest>
    > {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        `/auth/create-from-guest`,
        { method: "POST", body: JSON.stringify(params) }
      );
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_auth_create_from_guest_createFromGuest
      >;
    }
...
export namespace cart {
  export class ServiceClient {
     ...
     */
    public async add(
      params: RequestType<typeof api_cart_add_add>
    ): Promise<ResponseType<typeof api_cart_add_add>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/cart/add`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_cart_add_add
      >;
    }
    ...
    public async get(params: {
      user_id: number;
    }): Promise<ResponseType<typeof api_cart_get_get>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        `/cart/${encodeURIComponent(params.user_id)}`,
        { method: "GET", body: undefined }
      );
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_cart_get_get
      >;
    }
     ...
     */
    public async remove(
      params: RequestType<typeof api_cart_remove_remove>
    ): Promise<void> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
        cart_item_id: String(params["cart_item_id"]),
        user_id: String(params["user_id"]),
      });

      await this.baseClient.callTypedAPI(`/cart/remove`, {
        query,
        method: "DELETE",
        body: undefined,
      });
...
export namespace guest_cart {
  export class ServiceClient {
    ...
    public async add(
      params: RequestType<typeof api_guest_cart_add_add>
    ): Promise<ResponseType<typeof api_guest_cart_add_add>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/guest-cart/add`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_guest_cart_add_add
      >;
    }

    public async get(
      params: RequestType<typeof api_guest_cart_get_get>
    ): Promise<ResponseType<typeof api_guest_cart_get_get>> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/guest-cart`, {
        query,
        method: "GET",
        body: undefined,
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_guest_cart_get_get
      >;
    }

    public async remove(params: {
      id: number;
    }): Promise<ResponseType<typeof api_guest_cart_remove_remove>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        `/guest-cart/${encodeURIComponent(params.id)}`,
        { method: "DELETE", body: undefined }
      );
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_guest_cart_remove_remove
      >;
    }
  }
}
...
export namespace guest_orders {
  export class ServiceClient {
    ...
    public async create(
      params: RequestType<typeof api_guest_orders_create_create>
    ): Promise<ResponseType<typeof api_guest_orders_create_create>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/guest-orders`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_guest_orders_create_create
      >;
    }

    public async get(params: {
      id: number;
    }): Promise<ResponseType<typeof api_guest_orders_get_get>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        `/guest-orders/${encodeURIComponent(params.id)}`,
        { method: "GET", body: undefined }
      );
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_guest_orders_get_get
      >;
    }

    public async updateStatus(
      params: RequestType<typeof api_guest_orders_update_status_updateStatus>
    ): Promise<
      ResponseType<typeof api_guest_orders_update_status_updateStatus>
    > {
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        `/guest-orders/${encodeURIComponent(params.id)}/status`,
        { method: "PUT", body: JSON.stringify(body) }
      );
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_guest_orders_update_status_updateStatus
      >;
    }
  }
}
...
export namespace orders {
  export class ServiceClient {
     ...
     */
    public async create(
      params: RequestType<typeof api_orders_create_create>
    ): Promise<ResponseType<typeof api_orders_create_create>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/orders/create`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_orders_create_create
      >;
    }
  }
}
...
export namespace products {
  export class ServiceClient {
    ...
    public async create(
      params: RequestType<typeof api_products_create_create>
    ): Promise<ResponseType<typeof api_products_create_create>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/fragrances`, {
        method: "POST",
        body: JSON.stringify(params),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_products_create_create
      >;
    }

    public async deleteFragrance(params: {
      id: number;
    }): Promise<ResponseType<typeof api_products_delete_deleteFragrance>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        `/fragrances/${encodeURIComponent(params.id)}`,
        { method: "DELETE", body: undefined }
      );
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_products_delete_deleteFragrance
      >;
    }
    ...
    public async get(params: {
      id: number;
    }): Promise<ResponseType<typeof api_products_get_get>> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
     ...
     */
    public async list(
      params: RequestType<typeof api_products_list_list>
    ): Promise<ResponseType<typeof api_products_list_list>> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
        brand: params.brand,
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/products`, {
        query,
        method: "GET",
        body: undefined,
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_products_list_list
      >;
    }

    public async update(
      params: RequestType<typeof api_products_update_update>
    ): Promise<ResponseType<typeof api_products_update_update>> {
      // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
      const body: Record<string, any> = {
      ...
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
        typeof api_products_update_update
      >;
    }
  }
}
