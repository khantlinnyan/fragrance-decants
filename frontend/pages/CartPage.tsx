      ...
      <div className="min-h-screen bg-black">
        <div className="mx-auto max-w-4xl px-4 py-8">
          ...
          <div className="text-center py-20">
            <h1 className="text-2xl font-light text-white mb-4">Sign in to view your cart</h1>
            <p className="text-neutral-400">You need to be signed in to see your shopping cart.</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-black">
      <div className="mx-auto max-w-4xl px-4 py-8">
        ...
        {!cart || cart.items.length === 0 ? (
          <div className="text-center py-20">
            <p className="text-xl text-neutral-400 mb-4">Your cart is empty</p>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              {cart.items.map((item) => (
                <div
                  key={item.id}
                  className="flex items-center justify-between p-6 bg-neutral-900 rounded-lg"
                >
            ...
            <div className="border-t border-neutral-800 pt-8">
              <div className="bg-neutral-900 rounded-lg p-6 space-y-4">
                <div className="flex justify-between items-center text-lg">
                  <span className="font-light text-white">Subtotal</span>
                ...
                <Button
                  ...
                  className="w-full bg-white text-black hover:bg-neutral-200 font-light text-lg py-6 mt-6"
                >
