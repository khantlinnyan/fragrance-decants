...
```bash
git remote add encore encore://elegant-fragrance-decants-cswi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/elegant-fragrance-decants-cswi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/elegant-fragrance-decants-cswi/settings/integrations/github)
